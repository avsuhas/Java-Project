...
public class DepartmentsDao implements IDepartmentsDao{
	final Logger logger = Logger.getLogger(DepartmentsDao.class);
	...
	public List<DepartmentsDbo> findAll() {
			...
			try {
				...
				sbr.append("select dept_no,dept_name from employees.departments limit 20");
				pstmt = con.prepareStatement(sbr.toString());
				logger.info("I am executing query here : " + sbr.toString());
